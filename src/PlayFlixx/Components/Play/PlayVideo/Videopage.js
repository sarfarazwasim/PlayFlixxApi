  ...
  return (
    <div style={{marginLeft:"10%"}} >
      ...
      <div style={{display:"flex"}}>
        <span style={{marginTop:"0.6%",marginLeft:"-0%"}}>1476 COMMENTS</span>
        <span>
    ...
    <div >
      ...
      <div style={{zoom:"80%"}}>
        <Row>
          ...
          <span style={{display:"flex",justifyContent:"space-around",marginLeft:"-6%"}}>800</span></Col>
          <Col  ><button style={{backgroundColor:"transparent",zoom:"150%",
          ...
          <span style={{display:"flex",justifyContent:"space-around",marginLeft:"-6%"}}>Share</span></Col>
          <Col  ><button style={{backgroundColor:"transparent",zoom:"150%",
          borderColor:"transparent",border:"0px solid"}}><AiOutlineStar/></button>
          <span style={{display:"flex",justifyContent:"space-around",marginLeft:"-6%"}}>Save</span></Col>
        </Row>
      </div>
      <div style={{ borderTop: "2px solid #fff ",marginTop:"2%" }}></div>
      <div>
      ...
      <div style={{display:"flex",justifyContent:"space-between",fontSize:"small"}}>
        <span style={{marginTop:"2.5%",marginLeft:"-0%"}}>1476 COMMENTS</span>
        <span>
        <Dropdown style={{backgroundColor:"transparent"}}>
  <Dropdown.Toggle variant="success" id="dropdown-basic"
